...
public class SampleProgram1 extends BaseClass  {
	...
	@Test
	private void tc4(@Optional("greens")String s1,@Optional("greens@123")String s2) throws IOException, InterruptedException {
		fbLoginPojo f = new fbLoginPojo();
